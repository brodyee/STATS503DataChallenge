...
train.id <- read.table("trainInd.txt", header = F)
train <- data[train.id[,1],]
test <- data[-train.id[,1],]
```
...
trainingdata <- resp0
testdata <- resp1
write.csv(trainingdata, "~/Desktop/DataChallenge/Training Set.csv", row.names = F)
write.csv(testdata, "~/Desktop/DataChallenge/Test Set.csv", row.names = F)
```
